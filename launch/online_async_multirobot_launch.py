...
def generate_launch_description():
    ...
    low_res_remappings = common_remappings + [('/map', 'map_low')]
    ...
    high_res_slam = Node(
        ...
        namespace=namespace,
        output='screen',
        remappings=high_res_remappings,  # Use default map topic for high-res
        parameters=[
    ...
    low_res_slam = Node(
        package='slam_toolbox',
        executable='multirobot_slam_toolbox_node',
        name='slam_toolbox_lowres',
        namespace=namespace,
        output='screen',
        remappings=low_res_remappings,  # Remap to map_low
        parameters=[
